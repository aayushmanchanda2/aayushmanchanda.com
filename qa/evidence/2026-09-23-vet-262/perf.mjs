// VET-262 (copied from VET-261) scroll probe (from VET-260, data-mat gone): frame times while /tools scrolls, and every layer
...
await p.goto(`http://localhost:4329${route}`, { waitUntil: "networkidle" });
await p.evaluate(() => {
